...
echo [3/5] Fetching/vendoring attack tools into tools\ ...
python tools\fetch_tools.py

echo [4/5] Fetching the MITRE ATT&CK dataset (~50MB download, one-time)...
python tools\fetch_attack_data.py

echo [5/5] Building BugHuntHQ.exe with PyInstaller...
